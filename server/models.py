...
from sqlalchemy import Column, Integer, String, Text, Date, SmallInteger, ForeignKey, CheckConstraint, Enum, DateTime
...
class BookItem(Base):
    ...
    write_off_reasons = Column(Text)
    book_price = Column(Integer)
    shelf_location = Column(Text, nullable=False)
